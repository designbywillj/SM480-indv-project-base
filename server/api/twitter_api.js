...
const TWITTER_BEARER_TOKEN =
  "AAAAAAAAAAAAAAAAAAAAALJJLQEAAAAAMM88hKMMvNEShgxOIHEH8dIra%2BA%3DwwpyafVEeYGDtJMDNjQF0eNDLXWv8QMXblkrzBcfjNDQsZZtLv";
...
async function getTweetById(req, res) {
  ...
  const params = {
    ...
    "user.fields": "profile_image_url",
    "media.fields":
      "media_key,preview_image_url,type,url,width,height,public_metrics",
  };
